...
**254 unit tests (Vitest), including 56 official BIP-327 known-answer cases** — 30 that must be accepted, 26 that must be rejected — plus **206 end-to-end tests (Playwright)** across four browser engines. All pass.
